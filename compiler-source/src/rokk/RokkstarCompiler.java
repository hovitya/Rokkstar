...
public class RokkstarCompiler {
	...
	protected String compileBundle(File dir,String packageName) throws CompilerException{
		RokkstarPreferences.getInstance().loadMeta(dir.getAbsolutePath()+File.separator+"_meta");
		return this.processDir(dir, packageName);
	}
	...
	public void compile() throws CompilerException{
		try{
			...
			fw.write(this.compileBundle(dir, "core."));	
			...
			fw.write(this.compileBundle(dir, "core.skins."));	
			
			//Compile user files
			dir = new File(this.sourceDir);
			fw.write(this.compileBundle(dir, ""));
			fw.flush();
			fw.close();
